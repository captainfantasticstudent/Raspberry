<?php
	...
	if(isset($_POST['fill']) || isset($_POST['time']) || isset($_POST['fill1']) || isset($_POST['time1']) || isset($_POST['MaxI2']))
	{	
		...
		if(isset($_POST['time1']) && strlen($_POST['time1']) > 0){	
			...
			{
				$wszystko_ok = false;
				$_SESSION['e_message_czas1'] = 'Czas1 musi byc większy od Czas ub równy 0!';
			}
			if($wszystko_ok == true)
			{
				if ($polaczenie->connect_errno!=0) {
...
<body>
	...
	<div id="container3">
		...
		<div class="square_big3">
			...
			<img src="img/help1.jpg" alt="HELPPWM" width="300" />
			<p align="justify"> 
				<font size=3> 
					Proszę wybrać wypełnienie sygnału PWM i czas trwania zgrzewania o danym
					wypełnieniu (Rys. powyżej). Akceptowalna wartość PWM to zakres od <font color="red">0 do 99</font>. <br/>
					Czas trwania zadawania sygnału PWM podawany jest w mikisekundach.
					Łączny czas zgrzewania (CZAS i CZAS1) <font color="red">nie może przekraczać 1000 ms</font>.
				</font>
			</p>
		</div>
	</div>
